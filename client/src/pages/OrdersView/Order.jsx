    ...
    useEffect(() => {
        const fetchOrders = async () => {
            try {
                ...
                const response = await axios.get("https://thoriumstudio.xyz/api/get-all-receipts", {
                    headers: {
                                ...
                                <tbody className="bg-white divide-y divide-gray-200">
                                    {orders.map((order) => (
                                        <tr key={order.transaction_id} className="hover:bg-gray-50">
                                            ...
                                            <td className="px-6 py-4 whitespace-nowrap">
                                                <span
                                                    className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${getStatusColor(order.shipping_status)}`}
                                                >
